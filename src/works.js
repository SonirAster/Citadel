...
const state = {
    portfolio: [
        ...
        {images: [p4_photo1, p4_photo2, p4_photo3, p4_photo4, p4_photo5, p4_photo6, p4_photo7, p4_photo8], title: 'Sweet Recipes Book', link: 'https://soniraster.github.io/Sweet_Recipes_Book', description: 'The main concept we chose to create such sites is as follows: to show the variety of your products and their large quantity in such a way that each item does not lose its originality in a row with other equally interesting and attractive products.'},
    ...
    services: [
        ...
        { 'title': 'IT Consulting', 'description': 'We can consult you if you are not sure or would like to hear the opinion of a pro. We provide consulting services not only in development but also in domains and hostings.'
