        ...
        <div className={styles.main} ref={props.aboutRef}>
            <div className={styles.text}>
                ...
                <p className={styles.description}>
                    Citadel was founded as a circle of enthusiasts with different talents, ideals and traditions following the same goal: <span>Create</span>, <span>Support</span>, <span>Improve</span>. 
                    Citadel ordo Acris is the best 
